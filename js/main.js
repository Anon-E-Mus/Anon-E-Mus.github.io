...
class Preloader {
    constructor() {
        ...
        this.pageContent = document.querySelector('.page-content-wrapper');
        this.init();
    }

    init() {
        // Faster loading - fade out preloader after 1 second
        setTimeout(() => {
            this.preloader.classList.add('loaded');

            // Start fading in the page content slightly after preloader starts fading
            setTimeout(() => {
